...
import { showTextPreview } from "../extensions/features/context.ts";
import { config } from "../extensions/app/config/renderer.ts";
import {
  sharedToolHoverState,
  isToolCallHovered,
} from "../extensions/transcript/renderer/mouse/hover.ts";
import { installCompactMode } from "../extensions/transcript/renderer/compact-mode.ts";
import {
  getMessageDisplayTheme,
  installMessageDisplayRendering,
  setMessageDisplayTheme,
} from "../extensions/transcript/renderer/tool/message-display.ts";
import { ToolGroupComponent } from "../extensions/transcript/renderer/tool/grouping.ts";
import {
...
test("lazy-proxy tui: fullscreen hover uses scroll ancestor content width after reload", async () => {
  ...
  const reloadSpecifier = `../extensions/transcript/renderer/mouse/interaction.ts?reload=${Date.now()}`;
  const reloadedMouse: typeof import("../extensions/transcript/renderer/mouse/interaction.ts") =
