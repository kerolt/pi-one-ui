...
import { createAgentAutocompleteProvider } from "../extensions/features/reference/subagent.ts";
import { createAutocompleteProvider as createSessionAutocompleteProvider } from "../extensions/features/reference/index.ts";
